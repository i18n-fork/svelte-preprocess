...
## [5.0.18](https://github.com/3TiSite/svelte-preprocess/compare/v5.0.17...v5.0.18) (2024-06-02)



## [5.0.17](https://github.com/3TiSite/svelte-preprocess/compare/v5.0.16...v5.0.17) (2024-06-02)



## [5.0.16](https://github.com/3TiSite/svelte-preprocess/compare/v5.0.15...v5.0.16) (2024-06-02)



## [5.0.15](https://github.com/3TiSite/svelte-preprocess/compare/v5.0.14...v5.0.15) (2024-06-02)



## [5.0.14](https://github.com/3TiSite/svelte-preprocess/compare/v5.0.13...v5.0.14) (2024-06-02)



## [5.0.13](https://github.com/3TiSite/svelte-preprocess/compare/v5.0.12...v5.0.13) (2024-04-22)



## [5.0.12](https://github.com/3TiSite/svelte-preprocess/compare/v5.0.11...v5.0.12) (2024-3-20)
...
* **s:** msg ([b11ba4c](https://github.com/3TiSite/svelte-preprocess/commit/b11ba4c6a4fccb9d42fb2084dc4f005312e95597))
...
* **s:** msg ([bbebf63](https://github.com/3TiSite/svelte-preprocess/commit/bbebf63281b0229a28982a9e4a0a4a145ea91f80))
* **s:** msg ([72a5486](https://github.com/3TiSite/svelte-preprocess/commit/72a5486011a775aab1df3a8302e8592a0e4639ee))



## [5.0.6](https://github.com/3TiSite/svelte-preprocess/compare/v5.0.5...v5.0.6) (2023-10-24)



## [5.0.5](https://github.com/3TiSite/svelte-preprocess/compare/v5.0.4...v5.0.5) (2023-10-24)
...
* [scss] remove sourceMappingURL from result.code ([#297](https://github.com/wacfork/svelte-preprocess/issues/297)) ([2ff48f8](https://github.com/wacfork/svelte-preprocess/commit/2ff48f8c4fa94ae5782f24b39889f8a6a893eed1))
* 🐛 add `bare: true` to coffee compiler ([7d38bfd](https://github.com/wacfork/svelte-preprocess/commit/7d38bfde34b6fafeca7e8df490348fd2004cdb1a)), closes [#134](https://github.com/wacfork/svelte-preprocess/issues/134)
* 🐛 add more meaningful log to importAny ([2f7053e](https://github.com/wacfork/svelte-preprocess/commit/2f7053eeae6e1f779aca0868fb345e445d53bb90))
* 🐛 add preprocessors as optional peerDeps ([7f434df](https://github.com/wacfork/svelte-preprocess/commit/7f434dfc78c8118afbe7142d8061a2d3df1a330c)), closes [#137](https://github.com/wacfork/svelte-preprocess/issues/137)
* 🐛 add sugarss as optional dependency ([9ed25ee](https://github.com/wacfork/svelte-preprocess/commit/9ed25ee88c72ae28c5621e7228cddf53b4e7d791))
* 🐛 add sugarss v3 and v4 as supported ([3f2687b](https://github.com/wacfork/svelte-preprocess/commit/3f2687bc2c3036c96a95a0d491a9491f18e5c28f))
* 🐛 add svelte component typings to ts type scope ([434d0b4](https://github.com/wacfork/svelte-preprocess/commit/434d0b47bb639af826af9a3add474cca07aedaa7))
* 🐛 another type error :shrug: ([c55ad93](https://github.com/wacfork/svelte-preprocess/commit/c55ad935c0251579ef62d5e93b3abf7c4c672360))
* 🐛 attributes not being passed to transformers ([840239d](https://github.com/wacfork/svelte-preprocess/commit/840239d225f1ef0b7b642830093a8b6745d11ceb)), closes [#175](https://github.com/wacfork/svelte-preprocess/issues/175)
* 🐛 babel inputSourceMap object ([b81b268](https://github.com/wacfork/svelte-preprocess/commit/b81b268116523d419ee2d9ad95f422a1f91b6133)), closes [#215](https://github.com/wacfork/svelte-preprocess/issues/215)
* 🐛 better missing postcss message ([cafb6c6](https://github.com/wacfork/svelte-preprocess/commit/cafb6c6d7e369c11a7feda212a182f08c0f3a156)), closes [#301](https://github.com/wacfork/svelte-preprocess/issues/301)
* 🐛 bump minimum node version to 9.11.2 ([b8e0568](https://github.com/wacfork/svelte-preprocess/commit/b8e05688d8a2bcc390abd262cfe5e3338b06cc2b))
* 🐛 concat passed inclusion paths with default ones ([aac8cd4](https://github.com/wacfork/svelte-preprocess/commit/aac8cd47a1b8b5d8895027dad7d26f2dabea4c14))
* 🐛 custom transformer not working with external src files ([cc037c3](https://github.com/wacfork/svelte-preprocess/commit/cc037c3cdae72f16c1f977986a1434006dc3fe96))
* 🐛 cut 90% of downloaded package size ([882a4dd](https://github.com/wacfork/svelte-preprocess/commit/882a4dd5c185c5063ceb27884877958d4178c0e8))
* 🐛 empty scss content throwing error ([b4a4139](https://github.com/wacfork/svelte-preprocess/commit/b4a4139a72068db5d32d27c5209f9e24dbe313dc))
* 🐛 even more type fixes ([34af056](https://github.com/wacfork/svelte-preprocess/commit/34af05698823c1a679305214dad30598d9b514c0))
* 🐛 guarantee lowercase markup tagname ([051f595](https://github.com/wacfork/svelte-preprocess/commit/051f59549e25dfc0a4bce43d1f52ab327d3c76dd))
* 🐛 import less cjs instead of es6 ([bf8627f](https://github.com/wacfork/svelte-preprocess/commit/bf8627f3f4bde0d598769a67de10194bbcf04701))
* 🐛 inline :local without a scope not working ([6434a49](https://github.com/wacfork/svelte-preprocess/commit/6434a49e5f6391e8d9f927ca8e39f21d985216f1)), closes [#238](https://github.com/wacfork/svelte-preprocess/issues/238)
* 🐛 inverted conditionals on typescript transformer ([a6937f0](https://github.com/wacfork/svelte-preprocess/commit/a6937f0d9895ceca69bbb335d918bbe69d16c2a4))
* 🐛 language custom transformer overriding postcss ([4b35944](https://github.com/wacfork/svelte-preprocess/commit/4b35944f1d9b2886e0dccaf3f25486ab47e84710)), closes [#309](https://github.com/wacfork/svelte-preprocess/issues/309)
* 🐛 language custom transformer overriding postcss ([#311](https://github.com/wacfork/svelte-preprocess/issues/311)) ([3609aba](https://github.com/wacfork/svelte-preprocess/commit/3609abac05a121681103cc2c18ab454eb4fcc005)), closes [#309](https://github.com/wacfork/svelte-preprocess/issues/309)
* 🐛 language specific options not being set ([f3df8b0](https://github.com/wacfork/svelte-preprocess/commit/f3df8b06d62d38c7c5f4a100a0e7b2049fd3fd86)), closes [#231](https://github.com/wacfork/svelte-preprocess/issues/231)
* 🐛 less and stylus stand-alone processor ([85827bb](https://github.com/wacfork/svelte-preprocess/commit/85827bbd53340b39b99b706f03c926d3b01bbad6))
* 🐛 log a warning if local external file is not found ([774aece](https://github.com/wacfork/svelte-preprocess/commit/774aece08a5279a51707d3f428836169fc7735de)), closes [#174](https://github.com/wacfork/svelte-preprocess/issues/174)
* 🐛 make [@keyframe](https://github.com/keyframe) at-rules global. ([#65](https://github.com/wacfork/svelte-preprocess/issues/65)) ([40fb9be](https://github.com/wacfork/svelte-preprocess/commit/40fb9be28e5737259754e9b1168efcaf25eef171))
* 🐛 make markup tag regexp less greedy ([384ba5c](https://github.com/wacfork/svelte-preprocess/commit/384ba5cad0a2939a2717d9061dd928b4607e1431)), closes [#310](https://github.com/wacfork/svelte-preprocess/issues/310)
* 🐛 make postcss config error explicit ([21e3086](https://github.com/wacfork/svelte-preprocess/commit/21e30861ccc6d6c6b80cd9aad4a81b9e29a96c5e)), closes [#298](https://github.com/wacfork/svelte-preprocess/issues/298)
* 🐛 make pug mixins work with space AND tabs ([81b0154](https://github.com/wacfork/svelte-preprocess/commit/81b0154a2e90375a9f5793c8d7fd32698ef9f432))
* 🐛 more type fixes ([06dff79](https://github.com/wacfork/svelte-preprocess/commit/06dff79334a1c6a36aed9d6a30ac421ce09fb82e))
* 🐛 nth-child not being correctly globalified ([fa7249f](https://github.com/wacfork/svelte-preprocess/commit/fa7249f6988931f73c82e18554dcdf702bda5146)), closes [#224](https://github.com/wacfork/svelte-preprocess/issues/224)
* 🐛 pass less [@imports](https://github.com/imports) as dependencies to svelte ([55e9d28](https://github.com/wacfork/svelte-preprocess/commit/55e9d28fd03a2a1bf07c4d1b9ec3517fe2ce0cb3))
* 🐛 postcss config file support for sugarss ([36bdd66](https://github.com/wacfork/svelte-preprocess/commit/36bdd662c3b2a0b5b22df1d1aa3f1b48320bc187))
* 🐛 postcss installation check ([7df673a](https://github.com/wacfork/svelte-preprocess/commit/7df673a73ae2b12b89c174046b833bace7d97297))
* 🐛 postcss sourcemap ([8fe6543](https://github.com/wacfork/svelte-preprocess/commit/8fe6543a376be15a7a761a9bacdb66903b0388da)), closes [#251](https://github.com/wacfork/svelte-preprocess/issues/251)
* 🐛 postinstall script breaking on yarn v2 ([2f7f62b](https://github.com/wacfork/svelte-preprocess/commit/2f7f62b5e0137bd621f1bff930289d0d97631cb9))
* 🐛 prefixed keyframes globalization ([cdb5ae4](https://github.com/wacfork/svelte-preprocess/commit/cdb5ae4a31aa4c0d1934a7aa82337b3c86eed92e)), closes [#264](https://github.com/wacfork/svelte-preprocess/issues/264)
* 🐛 prevent globalify to wrongly split escaped selectors ([e9c4031](https://github.com/wacfork/svelte-preprocess/commit/e9c4031835ac18d713b5b50d909995677d516959)), closes [#191](https://github.com/wacfork/svelte-preprocess/issues/191)
* 🐛 prevent including external file if content is not empty ([24e90d1](https://github.com/wacfork/svelte-preprocess/commit/24e90d101103b043d4b9e9789d2d6582ecf31ae8)), closes [#183](https://github.com/wacfork/svelte-preprocess/issues/183)
* 🐛 prevent supressing generic errors on postcss transformer ([9a7dd49](https://github.com/wacfork/svelte-preprocess/commit/9a7dd4991ecbb9443bffe1d69b0cc68f513f59a7)), closes [#216](https://github.com/wacfork/svelte-preprocess/issues/216)
* 🐛 prevent svelte file from being added to scss dep list ([519b0b6](https://github.com/wacfork/svelte-preprocess/commit/519b0b6c49ba4a9e0f4adfcc47f03b19d2e28966)), closes [#346](https://github.com/wacfork/svelte-preprocess/issues/346)
* 🐛 prevent trying to resolve interpolated src values ([e71157c](https://github.com/wacfork/svelte-preprocess/commit/e71157c001ec7ba9f47b1ce4ad747a8a1a3258d5)), closes [#226](https://github.com/wacfork/svelte-preprocess/issues/226)
* 🐛 prevent ts from removing unused imports ([cfe6dcb](https://github.com/wacfork/svelte-preprocess/commit/cfe6dcbd23b7759f36bf7153222cab8e846cf8eb)), closes [#81](https://github.com/wacfork/svelte-preprocess/issues/81)
* 🐛 remove accidental console.log ([09e9aa8](https://github.com/wacfork/svelte-preprocess/commit/09e9aa8eca59c7fb9a946f17936e1156eada8113))
* 🐛 remove loose log ([e72650c](https://github.com/wacfork/svelte-preprocess/commit/e72650c5abf04659fb9ac62d346251c431b0dad1))
* 🐛 remove support for 'type' attribute ([07bc8aa](https://github.com/wacfork/svelte-preprocess/commit/07bc8aae571300413c52af05554b08451d338443))
* 🐛 remove support for custom default languages ([3d60856](https://github.com/wacfork/svelte-preprocess/commit/3d6085611120895b5527f4e17868105d6ec81c4d))
* 🐛 rename scss prepend option from `data` to `prependData` ([bd1caca](https://github.com/wacfork/svelte-preprocess/commit/bd1caca79d863cf08de353ed837de42b5ec063a1))
* 🐛 replace separator for windows support ([b60a0a8](https://github.com/wacfork/svelte-preprocess/commit/b60a0a830119eebd606245e71fdb6aadcee19135))
* 🐛 replacer preprocessor options types ([d3543da](https://github.com/wacfork/svelte-preprocess/commit/d3543dabfa434622bd28061099acc4c863f62710)), closes [#228](https://github.com/wacfork/svelte-preprocess/issues/228)
* 🐛 rollback last release ([b4461b4](https://github.com/wacfork/svelte-preprocess/commit/b4461b4431ce8d87ecd386f2fe40bb34775c3d8f))
* 🐛 run globalRule only if postcss is installed ([3c22a20](https://github.com/wacfork/svelte-preprocess/commit/3c22a203eb3fd565de783fdb6cb2e9faae270929))
* 🐛 sass tilde importer ([934fc04](https://github.com/wacfork/svelte-preprocess/commit/934fc04f197ada737b3b15780538bae3ab60bede))
* 🐛 scss prepending twice ([bc34b44](https://github.com/wacfork/svelte-preprocess/commit/bc34b44ddd23061df17cd0b8ae04c44c4b74d904)), closes [#200](https://github.com/wacfork/svelte-preprocess/issues/200)
* 🐛 scss with empty content ([12c3af3](https://github.com/wacfork/svelte-preprocess/commit/12c3af38aa191b15497418fa3bab8b1a241f21bb)), closes [#166](https://github.com/wacfork/svelte-preprocess/issues/166)
* 🐛 self-closing templates with external source ([b321dd7](https://github.com/wacfork/svelte-preprocess/commit/b321dd7f5040c5caa862a41cac5f5f859efc7a87)), closes [#235](https://github.com/wacfork/svelte-preprocess/issues/235)
* 🐛 set bare option to true ([312bbb9](https://github.com/wacfork/svelte-preprocess/commit/312bbb9bbf2668e1750296dbfc8b83bb39f291e8))
* 🐛 stand-alone processors not exported ([ced0fd1](https://github.com/wacfork/svelte-preprocess/commit/ced0fd1dfc34e13aefa13ba9d31efd81255e348d))
* 🐛 standalone processors breaking everything :) ([ce11323](https://github.com/wacfork/svelte-preprocess/commit/ce113236f0ca2fe5876b75d7c9935f664634cae0))
* 🐛 strip indent from indentation-sensitive languages only ([679488b](https://github.com/wacfork/svelte-preprocess/commit/679488b29cc98ebf0d9f679482bb78070e9cc1cb))
* 🐛 stylus imports on windows ([5bee6e0](https://github.com/wacfork/svelte-preprocess/commit/5bee6e0a73e3f11814e9002f4dafef3b762de95b))
* 🐛 support for self closing markup/template tag ([d109a89](https://github.com/wacfork/svelte-preprocess/commit/d109a89656c050a28efdbc908d58958deb0ec08d))
* 🐛 syntax and parser props from postcss config file ([74d4a89](https://github.com/wacfork/svelte-preprocess/commit/74d4a8923faf619c3908dd63ba40626835303363)), closes [#127](https://github.com/wacfork/svelte-preprocess/issues/127)
* 🐛 template preprocessing running on the whole file ([e37da9d](https://github.com/wacfork/svelte-preprocess/commit/e37da9d5f8f5fde5077e02add17be039db729e32))
* 🐛 throw if type errors are found ([6545a5c](https://github.com/wacfork/svelte-preprocess/commit/6545a5c13ff81a568714cbd83ae2d6127d4f61a4)), closes [#182](https://github.com/wacfork/svelte-preprocess/issues/182)
* 🐛 transformer imported dependencies being overwritten ([423c17a](https://github.com/wacfork/svelte-preprocess/commit/423c17a23283bca40ac0d8adf192ec1037196a12))
* 🐛 transformers type completion ([45ed796](https://github.com/wacfork/svelte-preprocess/commit/45ed796492f28a974af7f821e8305e9905a4c1cf))
* 🐛 transforming typescript without a tsconfig.json file ([7edb18a](https://github.com/wacfork/svelte-preprocess/commit/7edb18aa27d44a216bdab72264116ca7cd5762ab))
* 🐛 Try to only include files with local paths ([a167f6e](https://github.com/wacfork/svelte-preprocess/commit/a167f6e4cc4802f86cc14fe38bbacf7e9db02729))
* 🐛 try to use sass before node-sass ([10af027](https://github.com/wacfork/svelte-preprocess/commit/10af027bbff20ce5bb3a8e9829bba5cf9c461b98)), closes [#163](https://github.com/wacfork/svelte-preprocess/issues/163)
* 🐛 types for postcss 8 ([9b3cd3b](https://github.com/wacfork/svelte-preprocess/commit/9b3cd3b3b8b347a4c99efa189437c27f037ef6f5)), closes [#258](https://github.com/wacfork/svelte-preprocess/issues/258)
* 🐛 typescript imports on windows ([f6d6195](https://github.com/wacfork/svelte-preprocess/commit/f6d6195fc4d60d03c61a6c548066288967cf0d5f))
* 🐛 use ts import transformer when transpileOnly:true ([752fbde](https://github.com/wacfork/svelte-preprocess/commit/752fbdef99e9cc13ac75c95a7dcc1fa0928f72b3)), closes [#91](https://github.com/wacfork/svelte-preprocess/issues/91)
* 🐛 warn when global attr is used without potcss ([72360aa](https://github.com/wacfork/svelte-preprocess/commit/72360aafe4183997319f64a9c1b638a322e73fdd))
* 🐛 wrong typescript diagnostic filtering ([2630a44](https://github.com/wacfork/svelte-preprocess/commit/2630a44f4d6036a87f7120b5482b2c236cccd9a0)), closes [#49](https://github.com/wacfork/svelte-preprocess/issues/49)
* accept less v4 as peer dep ([#455](https://github.com/wacfork/svelte-preprocess/issues/455)) ([fbc484a](https://github.com/wacfork/svelte-preprocess/commit/fbc484a6d0394928c1318b70dfe007fed1d9fdac))
* accept postcss-load-config v2 or v3 ([#307](https://github.com/wacfork/svelte-preprocess/issues/307)) ([a31e794](https://github.com/wacfork/svelte-preprocess/commit/a31e79403f94cfd7db252a6152f120772acd4d6d))
* add # and numbers to ts store regex ([#473](https://github.com/wacfork/svelte-preprocess/issues/473)) ([881f3c9](https://github.com/wacfork/svelte-preprocess/commit/881f3c9ad6118fb66b560494a67042944567e0ec)), closes [#466](https://github.com/wacfork/svelte-preprocess/issues/466)
* add deprecation warning to defaults prop ([#393](https://github.com/wacfork/svelte-preprocess/issues/393)) ([406d3a8](https://github.com/wacfork/svelte-preprocess/commit/406d3a87c4779c16fca1264ce66fc491e5eec170))
* add pug const mixin ([#518](https://github.com/wacfork/svelte-preprocess/issues/518)) ([0551a9b](https://github.com/wacfork/svelte-preprocess/commit/0551a9b557ee18bb05a3e9021a8c9aa1f7b8c665)), closes [#467](https://github.com/wacfork/svelte-preprocess/issues/467)
* add quotes to ts store regex ([#403](https://github.com/wacfork/svelte-preprocess/issues/403)) ([9f2d7a0](https://github.com/wacfork/svelte-preprocess/commit/9f2d7a07053b8f010067bf7e55d99bccb2958567)), closes [#402](https://github.com/wacfork/svelte-preprocess/issues/402)
* add support for TypeScript 5 ([#585](https://github.com/wacfork/svelte-preprocess/issues/585)) ([adb87b9](https://github.com/wacfork/svelte-preprocess/commit/adb87b9c59fce4892a7c287efbb76a354b351ed6))
* add the comma into the list of combinators ([3335b32](https://github.com/wacfork/svelte-preprocess/commit/3335b3235cd8953bd8b669a20cca69e0ab5970be))
* address breaking changes in TypeScript 5 ([#587](https://github.com/wacfork/svelte-preprocess/issues/587)) ([a80dd35](https://github.com/wacfork/svelte-preprocess/commit/a80dd351629b74c01a58d6814759f550f17800b7)), closes [#586](https://github.com/wacfork/svelte-preprocess/issues/586)
* adjust store regex ([#441](https://github.com/wacfork/svelte-preprocess/issues/441)) ([85a86c8](https://github.com/wacfork/svelte-preprocess/commit/85a86c86513f98c2b02f2d314a18b0e68378c8f6)), closes [#433](https://github.com/wacfork/svelte-preprocess/issues/433)
* adjust typescript peer dep ([#479](https://github.com/wacfork/svelte-preprocess/issues/479)) ([68fae2c](https://github.com/wacfork/svelte-preprocess/commit/68fae2c56fb3e22ff21f12c9aab74b42ad4f7bb8))
* allow typescript v4 ([c584bcf](https://github.com/wacfork/svelte-preprocess/commit/c584bcff7fcb1021cd21b82b79c8b4608f2f8d5a))
* always use absolute paths for less imports ([#495](https://github.com/wacfork/svelte-preprocess/issues/495)) ([#496](https://github.com/wacfork/svelte-preprocess/issues/496)) ([be0fda4](https://github.com/wacfork/svelte-preprocess/commit/be0fda4ddbe95040221ff248ccbb492fb5555334))
* avoid reporting 'Cannot find name '{0}'. Did you mean '{1}'?' for reactive variables ([#126](https://github.com/wacfork/svelte-preprocess/issues/126)) ([a267885](https://github.com/wacfork/svelte-preprocess/commit/a267885e48a20c913368feafda153fa2389609e1))
* better pug error message ([#448](https://github.com/wacfork/svelte-preprocess/issues/448)) ([a239e82](https://github.com/wacfork/svelte-preprocess/commit/a239e829295bde5f62383697266cefe7767dd0e2)), closes [#447](https://github.com/wacfork/svelte-preprocess/issues/447)
* Clear outDir if set in tsconfig ([#406](https://github.com/wacfork/svelte-preprocess/issues/406)) ([67f96ad](https://github.com/wacfork/svelte-preprocess/commit/67f96ad9fcc4e0efb337d469533ff68d6189c024)), closes [#405](https://github.com/wacfork/svelte-preprocess/issues/405)
* coffeescript sourcemap ([#416](https://github.com/wacfork/svelte-preprocess/issues/416)) ([6cc54b6](https://github.com/wacfork/svelte-preprocess/commit/6cc54b63fd8eb42a5e2460b30bba4d7a85846958))
* default ts option object ([07ba62f](https://github.com/wacfork/svelte-preprocess/commit/07ba62f1fc8e73b547648744c805617e651acc9f))
* deprecate type attribute ([#417](https://github.com/wacfork/svelte-preprocess/issues/417)) ([2632a88](https://github.com/wacfork/svelte-preprocess/commit/2632a88d380a14843393d5246f471a8c6446a3b5))
* do not break when :global is the only selector ([f011b74](https://github.com/wacfork/svelte-preprocess/commit/f011b74be18493de575920cea6b81a7287fc3c3a))
* don't overwrite target from tsconfig.json ([#408](https://github.com/wacfork/svelte-preprocess/issues/408)) ([11cb508](https://github.com/wacfork/svelte-preprocess/commit/11cb5083b1c9a946ea8c0f499ccbca753908e411))
* don't try to include local files that doesn't exist ([52594eb](https://github.com/wacfork/svelte-preprocess/commit/52594eb79e7533a442fd7063ef1e2e269269dbc3))
* fallback to empty string if there are no attributes ([#397](https://github.com/wacfork/svelte-preprocess/issues/397)) ([b25838f](https://github.com/wacfork/svelte-preprocess/commit/b25838f5b11afa8143aa59cfefa9b0881b4879cb)), closes [#396](https://github.com/wacfork/svelte-preprocess/issues/396)
* fix ([e59a0db](https://github.com/wacfork/svelte-preprocess/commit/e59a0dbcf35f74e86baeaa0632dfecd1772afd1d))
* fix ([209ce1e](https://github.com/wacfork/svelte-preprocess/commit/209ce1e6f8df7135b1e33a6ec3b6d2a0e13d3baa))
* fix ([32c4f6e](https://github.com/wacfork/svelte-preprocess/commit/32c4f6ea703a84116916b64738ce268f466ad8ff))
* generate high resolution source map ([#443](https://github.com/wacfork/svelte-preprocess/issues/443)) ([57012ba](https://github.com/wacfork/svelte-preprocess/commit/57012ba9f87abfec99f061196fb955da4ccfa384))
* handle $store imported in module script ([#404](https://github.com/wacfork/svelte-preprocess/issues/404)) ([162faa4](https://github.com/wacfork/svelte-preprocess/commit/162faa40949468eb07a73116740d3415775ddc9a)), closes [#401](https://github.com/wacfork/svelte-preprocess/issues/401)
* map .sss as .css to support sugarss extension ([2c0bd45](https://github.com/wacfork/svelte-preprocess/commit/2c0bd4561fc3dd53ff525509925bcc9c5f7b436b))
* merge ([af6f383](https://github.com/wacfork/svelte-preprocess/commit/af6f3831c05921d44c4f65a9b7d90a099cc0666c))
* merge globalStyle and globalRule transformers ([a61ada6](https://github.com/wacfork/svelte-preprocess/commit/a61ada6cf9b27452cebe8ac00cfa0ce873ce74bd))
* only try to load external files with relative paths ([#487](https://github.com/wacfork/svelte-preprocess/issues/487)) ([80d87ed](https://github.com/wacfork/svelte-preprocess/commit/80d87edac4723401db47d06ed03bb6cd388c21d9))
* paths in postcss sourcemap sources array ([#500](https://github.com/wacfork/svelte-preprocess/issues/500)) ([2027375](https://github.com/wacfork/svelte-preprocess/commit/2027375969255d11708340ee40eb2e3ded7ddb35))
* preserve `[@font-face](https://github.com/font-face)` inside `:global` block ([#486](https://github.com/wacfork/svelte-preprocess/issues/486)) ([8064473](https://github.com/wacfork/svelte-preprocess/commit/8064473ae107f6e2d34eb9590e4befa70ce4618c)), closes [#236](https://github.com/wacfork/svelte-preprocess/issues/236)
* provide caller information to Babel ([#449](https://github.com/wacfork/svelte-preprocess/issues/449)) ([51007ab](https://github.com/wacfork/svelte-preprocess/commit/51007abf946ffdd1d407c6bcf86439d38e113626))
* pug mixin elseif ([#45](https://github.com/wacfork/svelte-preprocess/issues/45)) ([98ad9ca](https://github.com/wacfork/svelte-preprocess/commit/98ad9ca996c70da25666e4f1e9286d4dfd15fb36))
* quotes in the release script ([#173](https://github.com/wacfork/svelte-preprocess/issues/173)) ([5550b3e](https://github.com/wacfork/svelte-preprocess/commit/5550b3eea390148e9e5683ec214bddae7531a405))
* relax TS peer dep requirement ([#400](https://github.com/wacfork/svelte-preprocess/issues/400)) ([f8a0f49](https://github.com/wacfork/svelte-preprocess/commit/f8a0f49fd02aea1fdb5c463496a5939186948cd2)), closes [#395](https://github.com/wacfork/svelte-preprocess/issues/395)
* remove deprecated package @types/sass ([#583](https://github.com/wacfork/svelte-preprocess/issues/583)) ([731516d](https://github.com/wacfork/svelte-preprocess/commit/731516d51343f4503b5a9a1653cd88558c800bd3))
* remove extra identation for sass content ([7d0f437](https://github.com/wacfork/svelte-preprocess/commit/7d0f4376037d1ff6b426e2d6882adb6b08d95464))
* rename typescript configuration option to honor the readme docs ([67f2137](https://github.com/wacfork/svelte-preprocess/commit/67f2137f9b6c11f3d2f4508d6dab2699e0d0b823))
* return default settings when no tsconfig found ([#407](https://github.com/wacfork/svelte-preprocess/issues/407)) ([473408b](https://github.com/wacfork/svelte-preprocess/commit/473408b8dcec6cd1540d3fb8e05ca0b4a82ec2f5))
* revert "refactor: use fs/promises" ([3f9572c](https://github.com/wacfork/svelte-preprocess/commit/3f9572ca30e9a05439a6deddc327fa340dd1ef34))
* spell. "identation" → "indentation " ([#598](https://github.com/wacfork/svelte-preprocess/issues/598)) ([aa86f0b](https://github.com/wacfork/svelte-preprocess/commit/aa86f0b366ca063788119ebc40c5e4ba5a385661))
...
* standalone preprocessors prepending data in other languages ([#380](https://github.com/wacfork/svelte-preprocess/issues/380)) ([e6679e4](https://github.com/wacfork/svelte-preprocess/commit/e6679e4b81cd145202b293aca1035cd2dc05ef71))
* stylus - handle relative sourcemap sources([#513](https://github.com/wacfork/svelte-preprocess/issues/513)) ([77bd3bf](https://github.com/wacfork/svelte-preprocess/commit/77bd3bf69554afbc45d6f1e34a4eb5abf398a933))
* support ts build with no tsconfig.json ([cf0e44c](https://github.com/wacfork/svelte-preprocess/commit/cf0e44c26212b496cda8686d2780e7e8f1ac8f7a))
* teach the globalifySelector to determine combinators ([174c406](https://github.com/wacfork/svelte-preprocess/commit/174c4068bad87d6bcb665cc51bd04d1ae367d855))
* translate options.sourceMap to options.compilerOptions.sourceMap for ts ([#286](https://github.com/wacfork/svelte-preprocess/issues/286)) ([#299](https://github.com/wacfork/svelte-preprocess/issues/299)) ([c8a3cd6](https://github.com/wacfork/svelte-preprocess/commit/c8a3cd6736054510bc0eeccc242b8f5c4f0b7c5a))
* ts preprocessor - consider store suffixed with number ([#461](https://github.com/wacfork/svelte-preprocess/issues/461)) ([a7a94cf](https://github.com/wacfork/svelte-preprocess/commit/a7a94cfb29f6ea85cfafd1afa2c61363f72cb4b3)), closes [sveltejs/svelte#7120](https://github.com/sveltejs/svelte/issues/7120)
* typescript: importing component from pnpm monorepo p… ([#337](https://github.com/wacfork/svelte-preprocess/issues/337)) ([bf72637](https://github.com/wacfork/svelte-preprocess/commit/bf726371e43dd3bc617511690be6cf6a2845e389))
* use the typescript transform to remove type imports ([3a15831](https://github.com/wacfork/svelte-preprocess/commit/3a158318a77ca627bd1e365fb96dde1b6fefe1c0))


### Code Refactoring

* 💡 remove deprecated autoProcess props ([7fbff08](https://github.com/wacfork/svelte-preprocess/commit/7fbff088f08039cee25534385dfaebc590a0d813))


### Features

* 🎸 add "markupTagName" option ([746d2ab](https://github.com/wacfork/svelte-preprocess/commit/746d2abbaaf072d3fac29cc2d2c0f61fa28d58e8))
* 🎸 add "transpileOnly" option to skip type check ([3e46741](https://github.com/wacfork/svelte-preprocess/commit/3e46741d917b8be5dcd331f5672bcd0c7ff75090)), closes [#54](https://github.com/wacfork/svelte-preprocess/issues/54)
* 🎸 add `replace` transformer ([06981f4](https://github.com/wacfork/svelte-preprocess/commit/06981f410d0427bc75119cebebcb4b35c4b9a7dc))
* 🎸 add babel transformer ([1776917](https://github.com/wacfork/svelte-preprocess/commit/1776917717a5308b4a631e7a89fa56cf509d365b)), closes [#108](https://github.com/wacfork/svelte-preprocess/issues/108)
* 🎸 add external src support for stand-alone processors ([974ab5a](https://github.com/wacfork/svelte-preprocess/commit/974ab5a05c37e32da1abe0e59fb777d07efb0b3c))
* 🎸 add globalStyle.sourceMap and globalRule.sourceMap opts ([2717c5b](https://github.com/wacfork/svelte-preprocess/commit/2717c5b62eff78c512913adfb166439242715973))
* 🎸 add scss support for tilde (~) imports ([5b5c692](https://github.com/wacfork/svelte-preprocess/commit/5b5c6924829910d363fe27ba4658cab7a0f06de0)), closes [#277](https://github.com/wacfork/svelte-preprocess/issues/277)
* 🎸 add sourceMap prop to configuration object ([9156efc](https://github.com/wacfork/svelte-preprocess/commit/9156efc0d25e0a3642bf66e931b310eb62c4ec2f))
* 🎸 add stand-alone processors ([f19c90a](https://github.com/wacfork/svelte-preprocess/commit/f19c90a1ed2838a8712b0c95dccbd8b005d8f9c0))
* 🎸 add support for lang=sugarss & type=text/sugarss ([bd8f362](https://github.com/wacfork/svelte-preprocess/commit/bd8f362d7bddb9497c8ec64eaed0e0f40fe8956a)), closes [#250](https://github.com/wacfork/svelte-preprocess/issues/250)
* 🎸 add support for typescript type checking ([#37](https://github.com/wacfork/svelte-preprocess/issues/37)) ([e6dd744](https://github.com/wacfork/svelte-preprocess/commit/e6dd7441db64906f79d7105723e23a8ef949e2d5))
* 🎸 add svelte pug mixins ([#38](https://github.com/wacfork/svelte-preprocess/issues/38)) ([543ab75](https://github.com/wacfork/svelte-preprocess/commit/543ab7557bd8e8172ea52e89355101d3c88a38ba))
* 🎸 add typescript preprocessor ([c195aa1](https://github.com/wacfork/svelte-preprocess/commit/c195aa183b60899603d72743432de501b23f6087))
* 🎸 allow to watch stylus dependencies ([8aa3dfc](https://github.com/wacfork/svelte-preprocess/commit/8aa3dfcd73730688c3a4d555ebf5a56cf36c669f))
* 🎸 bump minimum node version to 14 ([2806ada](https://github.com/wacfork/svelte-preprocess/commit/2806ada4659b11a1f37c987e2b52d47864cca305))
* 🎸 enable sourceMap for dev environment automatically ([4df9031](https://github.com/wacfork/svelte-preprocess/commit/4df9031d942dd4ecc0f47878c21c54cd15552285))
* 🎸 support :local() pseudo-selector for global styles ([52277a8](https://github.com/wacfork/svelte-preprocess/commit/52277a8af5492e1b0fc10cde16299a70da72cfdd))
* 🎸 support async onBefore() ([a6af2a2](https://github.com/wacfork/svelte-preprocess/commit/a6af2a276cfc728ed60631eba5072b83cb035991))
* 🎸 support defining default languages ([6483879](https://github.com/wacfork/svelte-preprocess/commit/6483879e4a316d60a2e0655746a342c6debb90be)), closes [#189](https://github.com/wacfork/svelte-preprocess/issues/189)
* 🎸 support markup preprocessing with no tags ([a1a3360](https://github.com/wacfork/svelte-preprocess/commit/a1a33602bf1badd49e01188a9d63b8ef653a13a9))
* 🎸 support prependData for almost every preprocessor ([b80ca90](https://github.com/wacfork/svelte-preprocess/commit/b80ca90802d2c17fa249b06fb17e678fff443656))
* 🎸 support template wrappers in separate markup processors ([dc52009](https://github.com/wacfork/svelte-preprocess/commit/dc520096d4ae7d0a8f610f2e3cdc8ea7f2abfb1b)), closes [#211](https://github.com/wacfork/svelte-preprocess/issues/211)
* 🎸 watch included pug files ([a8855fb](https://github.com/wacfork/svelte-preprocess/commit/a8855fb7a92affe27490c14f14341403568132d5))
* 🎸 watch internal files imported with postcss-import ([5b14624](https://github.com/wacfork/svelte-preprocess/commit/5b14624ac04a9812e680b252b8f6d69c97c30188))
* add +html mixin for pug ([#245](https://github.com/wacfork/svelte-preprocess/issues/245)) ([d2d6d13](https://github.com/wacfork/svelte-preprocess/commit/d2d6d13318668818682b5dda8ac318b98c499384))
* add an option to render scss synchronously via renderSync ([#123](https://github.com/wacfork/svelte-preprocess/issues/123)) ([1c9285d](https://github.com/wacfork/svelte-preprocess/commit/1c9285d508ec2fd0bea9b9f77a0940c6b3e00b89))
* add implementation option for scss ([e4ca556](https://github.com/wacfork/svelte-preprocess/commit/e4ca556821785e2b853f1668489912ebab21ee4b))
* add new syntax {key} for `pug` ([#259](https://github.com/wacfork/svelte-preprocess/issues/259)) ([707206f](https://github.com/wacfork/svelte-preprocess/commit/707206f7457cf5e066c95a18d3f99f48ea61481d))
* add the [@global](https://github.com/global) {} rule support ([453c4be](https://github.com/wacfork/svelte-preprocess/commit/453c4be2a2318d90cd86644d78e72404c72bd774))
* better Typescript transpilation ([#392](https://github.com/wacfork/svelte-preprocess/issues/392)) ([a1c54fc](https://github.com/wacfork/svelte-preprocess/commit/a1c54fc7b0d0d21fd9adbee8aeeb8f3667b375c9))
* drop Node 10 and 12. Add 16 and 18 ([#561](https://github.com/wacfork/svelte-preprocess/issues/561)) ([ba4299d](https://github.com/wacfork/svelte-preprocess/commit/ba4299de98a2f7daba5b2a58ce4c39b2a66f2c41))
* export autopreprocess options type ([f5e1a63](https://github.com/wacfork/svelte-preprocess/commit/f5e1a635f586a9780b0a71db979f6ffb30b31221))
* prepend scss with data property ([#36](https://github.com/wacfork/svelte-preprocess/issues/36)) ([dfa2b2a](https://github.com/wacfork/svelte-preprocess/commit/dfa2b2a24124c94c3d3af6e63eff8963489f7caa))
* replace the [@global](https://github.com/global) for :global for CSS modules compliance ([cca29fb](https://github.com/wacfork/svelte-preprocess/commit/cca29fba848d3f75b6ba354a9909c1de021c7971))
* support dart-sass ([e56f8b2](https://github.com/wacfork/svelte-preprocess/commit/e56f8b24c8f93db82ef9bb0f17dd658aaf000126))
* support preserveValueImports introduced in TS 4.5 ([#434](https://github.com/wacfork/svelte-preprocess/issues/434)) ([4ea9982](https://github.com/wacfork/svelte-preprocess/commit/4ea9982249df9858439bb3588224e804107f0986))
* support tsconfig extends ([#328](https://github.com/wacfork/svelte-preprocess/issues/328)) ([d0b4766](https://github.com/wacfork/svelte-preprocess/commit/d0b476615d72deaa4eff5f2f164b245c0dd294d7)), closes [#300](https://github.com/wacfork/svelte-preprocess/issues/300)


### Performance Improvements

* ⚡️ make postcss-load-config optional for better pkg size ([7ab9c72](https://github.com/wacfork/svelte-preprocess/commit/7ab9c72797a3b702f2f3dd9280402b84057398be))
* ⚡️ remove support for deprecated node-sass ([a617fe1](https://github.com/wacfork/svelte-preprocess/commit/a617fe13b0922188346775475325ab8af83c56f7))
* cache tsconfig ([#398](https://github.com/wacfork/svelte-preprocess/issues/398)) ([5aa60cb](https://github.com/wacfork/svelte-preprocess/commit/5aa60cb86c89c0649a548507f6d142937f76df7a)), closes [#383](https://github.com/wacfork/svelte-preprocess/issues/383)
* rewrite in typescript ([#80](https://github.com/wacfork/svelte-preprocess/issues/80)) ([f71f29c](https://github.com/wacfork/svelte-preprocess/commit/f71f29c2fd051b9548845cfc188c3a245be6eb27))
...
## [5.0.23](https://github.com/wacfork/svelte-preprocess/compare/v5.0.22...v5.0.23) (2023-10-20)



## [5.0.22](https://github.com/wacfork/svelte-preprocess/compare/v5.0.21...v5.0.22) (2023-10-20)



## [5.0.21](https://github.com/wacfork/svelte-preprocess/compare/v5.0.20...v5.0.21) (2023-10-09)
